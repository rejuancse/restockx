...
class Initial_Setup {
    ...
    protected function output_wc_requirement_message() {
        $text = esc_html__( 'WooCommerce', 'alertx' );
        ...
        $message = sprintf(
            ...
            esc_html__( 'Thanks for installing AlertX for WooCommerce, you rock! 🤘', 'alertx' ),
            esc_html__( 'To enable eCommerce features, you need to install the', 'alertx'),
            '<a class="thickbox open-plugin-details-modal" href="' . $link . '"><strong>' . esc_html__( 'WooCommerce', 'alertx' ) . '</strong></a>',
            esc_html__( 'plugin.', 'alertx' )
        );
